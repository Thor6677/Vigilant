...
function Demo() {
  ...
  return (
    <>
      ...
      <main className="b-main">
        ...
        {bannerVisible && (
          <Banner tone="danger" onDismiss={() => setBannerVisible(false)}>
            Structure ALERT — Example Citadel armor timer in 3h 12m
          </Banner>
        )}
        <StatStrip>
        ...
        <Grid cols={2}>
          <Panel title="Fleet Status" glass brackets>
            <KeyValueRow label="Example Citadel" value="ONLINE" tone="ok" />
      ...
      <Footer links={[{ label: 'GitHub', href: '#' }, { label: 'Status', href: '#' }]} brand="VIGILANT" />
    </>
  );
}
