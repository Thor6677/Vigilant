...
| Background | Ambient "flying through New Eden" canvas: real SDE system coordinates (5,485 k-space systems from `frontend/public/data/systems.json`), no jump lines, camera on a slow elliptical cruise through the disc, depth fog + soft star glow |
