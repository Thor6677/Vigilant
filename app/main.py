...
# MUST precede dscan_router: dscan declares the catch-all `/intel/{scan_id}`,
# and FastAPI matches in registration order — so any literal /intel/<name>
# route registered after it is shadowed and resolves as a scan id instead.
# This previously swallowed /intel/tracker, rendering "Intel not found or has
# expired" on the WH Tracker page. Add future literal /intel/* routes above.
