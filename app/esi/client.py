...
class ESIClient:
    def __init__(self, token: str, db: AsyncSession | None = None, *, cache_enabled: bool | None = None):
        ...
        self.headers = {
            ...
            # CCP requires a contactable User-Agent. Built here (per-instance,
            # i.e. per-request) rather than at module import so the address
            # comes from the CONTACT_EMAIL setting.
