...
# CCP requires a contactable User-Agent. Built at request time from
# app.config.user_agent(), which embeds the CONTACT_EMAIL setting so
# self-hosters advertise their own address instead of the upstream author's.
