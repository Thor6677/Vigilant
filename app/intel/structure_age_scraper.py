...
async def run_phase1() -> dict:
    ...
    # Bulk archive/scrape traffic: the "backfill" token lets EVERef and
    # triff.tools tell it apart from interactive requests. Built at call time.
    headers = {"User-Agent": user_agent("backfill")}
