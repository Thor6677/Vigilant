...
[![tests](https://github.com/Thor6677/Vigilant/actions/workflows/tests.yml/badge.svg)](https://github.com/Thor6677/Vigilant/actions/workflows/tests.yml)
...
<p align="center">
  <img src="docs/screenshots/dashboard.jpg" alt="Vigilant dashboard — every character in one view with wallet, location, ship, clones and skill training" width="900">
  <br>
  <em>The dashboard: every character on one page — wallet, location, current ship, clones, and skill training, grouped by account.</em>
</p>
...
<table>
  <tr>
    <td width="50%">
      <a href="docs/screenshots/star-map.jpg"><img src="docs/screenshots/star-map.jpg" alt="Star map"></a>
      <p align="center"><strong>Star map</strong> — ~5,485 K-space systems and ~6,985 stargate links in WebGL, with the security overlay.</p>
    </td>
    <td width="50%">
      <a href="docs/screenshots/kill-feed.jpg"><img src="docs/screenshots/kill-feed.jpg" alt="Kill feed"></a>
      <p align="center"><strong>Kill feed</strong> — live kills with the most valuable structure and ship losses of the last 7 days.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <a href="docs/screenshots/corporations.jpg"><img src="docs/screenshots/corporations.jpg" alt="Corporations"></a>
      <p align="center"><strong>Corporations</strong> — every corp your characters belong to, player and NPC, with the corp scopes each one has granted.</p>
    </td>
    <td width="50%">
      <a href="docs/screenshots/corporation-detail.jpg"><img src="docs/screenshots/corporation-detail.jpg" alt="Corporation detail"></a>
      <p align="center"><strong>Corporation detail</strong> — members, per-character scopes, wallet divisions, and structures with fuel and vulnerability timers.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <a href="docs/screenshots/ship-fitting.jpg"><img src="docs/screenshots/ship-fitting.jpg" alt="Ship fitting tool"></a>
      <p align="center"><strong>Ship fitting</strong> — full stat simulation: EHP, resist profile, fitting resources, and capacitor.</p>
    </td>
    <td width="50%">
      <a href="docs/screenshots/market-price-history.jpg"><img src="docs/screenshots/market-price-history.jpg" alt="Market price history"></a>
      <p align="center"><strong>Market</strong> — daily price history and traded volume for any published item.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <a href="docs/screenshots/gate-check.jpg"><img src="docs/screenshots/gate-check.jpg" alt="Gate check"></a>
      <p align="center"><strong>Gate check</strong> — route safety scored per jump from recent kill activity.</p>
    </td>
    <td width="50%">
      <a href="docs/screenshots/industry.jpg"><img src="docs/screenshots/industry.jpg" alt="Industry tools"></a>
      <p align="center"><strong>Industry</strong> — manufacturing, build finder, compression, hauling, mining ledger, and PI.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <a href="docs/screenshots/skill-plans.jpg"><img src="docs/screenshots/skill-plans.jpg" alt="Skill plans"></a>
      <p align="center"><strong>Skill plans</strong> — shared plans with per-character gap analysis and training estimates.</p>
    </td>
    <td width="50%">
      <a href="docs/screenshots/login.jpg"><img src="docs/screenshots/login.jpg" alt="Login screen"></a>
      <p align="center"><strong>Sign-in</strong> — EVE SSO only. No passwords are ever stored.</p>
    </td>
  </tr>
</table>
...
| A `vigilant-updater-selfupdate` container is lying around | The self-update helper. It is deliberately not `--rm`, so its exit code and logs survive as the post-mortem | `docker logs vigilant-updater-selfupdate` to see what happened, then `docker rm vigilant-updater-selfupdate`. The sidecar removes it by itself once it has read it, so a lingering one means the sidecar never restarted |
...
The account that owns the character set in `ADMIN_CHARACTER_ID` becomes admin at startup (see "First-User Admin Bootstrap"). Admins can promote other users to Manager or Admin roles from `/admin`.
...
Vigilant's source code is released under the **MIT License** — see [LICENSE](LICENSE). You are free to use, modify, and self-host it, commercially or otherwise, without asking permission. It is provided **as-is, with no warranty and no obligation of support**.

The MIT license covers this project's own code. It does **not** cover the EVE Online material that Vigilant consumes — the Static Data Export, type names and item data, and EVE artwork — whose use is governed by the game operator's third-party developer terms. See [NOTICE](NOTICE).
